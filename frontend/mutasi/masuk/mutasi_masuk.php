...
<body>
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th scope="col">
                    <button type="button" class="btn btn-primary" onClick="window.open('tambah_mutasi_masuk.php');">
        ...
        <tbody>
            <?php
                while ($data = mysqli_fetch_array($mutasi_masuk)) {
            ?>
            <tr>
                <th scope="row">1</th>
                ...
                <td class="d-flex justify-content-end">
                    <a href="../../../backend/mutasi/masuk/delete_mutasi_masuk.php?id=<?php echo $data['toto']; ?>">
