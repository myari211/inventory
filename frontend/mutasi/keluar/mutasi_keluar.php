...
<div class="row" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        <ul class="list-group">
            ...
            <div id='submenu3' class="collapse sidebar-submenu">
                <a href="../masuk/mutasi_masuk.php" class="list-group-item list-group-item-action bg-dark text-white d-inline-flex justify-content-between">
                    <span class="menu-collapsed">Mutasi Masuk</span>
                    <i class="material-icons" style="font-size:15px;">vertical_align_bottom</i>
                </a>
                <a href="mutasi_keluar.php" class="list-group-item list-group-item-action bg-dark text-white d-inline-flex justify-content-between">
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                <th scope="col">
                    <button type="button" class="btn btn-primary" onClick="window.open('tambah_mutasi_keluar.php');">
        ...
        <tbody>
            <?php
                while ($data = mysqli_fetch_array($mutasi_keluar)) {
            ?>
            <tr>
                <th scope="row">1</th>
                ...
                <td class="d-flex justify-content-end">
                    <a href="../../../backend/mutasi/keluar/delete_mutasi_keluar.php?id=<?php echo $data['toto']; ?>">
