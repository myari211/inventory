    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        <ul class="list-group">
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="barang.php" class="list-group-item list-group-item-action bg-dark text-white d-inline-flex justify-content-between">
                    <span class="menu-collapsed">Daftar Barang</span>
                    <i class="material-icons" style="font-size:15px;">layers</i>
                </a>
                <a href="tambah_barang.php" class="list-group-item list-group-item-action bg-dark text-white d-inline-flex justify-content-between">
